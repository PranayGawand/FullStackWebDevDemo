...
<% 
	if((request.getParameter("finishupdate") != null) || (request.getParameter("finishownupdate") != null) && ((Boolean)session.getAttribute("isOracleLogin")) && ((Boolean)session.getAttribute("isUserLogin")))
        {			
        	...
        	try{
        		...
        		while(rset.next()){
	        		...
	        		if (!flag.equals(1)){
			        	...
			        	out.println("setTimeout("+"\"javascript:location.href='../view/chooseUpdateUser.html'\""+", 2500);");
				...
				if(request.getParameter("finishupdate") != null)
					...
					if (classtype.equals("a"))
						out.println("setTimeout("+"\"javascript:location.href='../view/administrator.html'\""+", 2500);");
					else if (classtype.equals("d"))
						out.println("setTimeout("+"\"javascript:location.href='../view/doctor.html'\""+", 2500);");
					else if (classtype.equals("r"))
						out.println("setTimeout("+"\"javascript:location.href='../view/radiologist.html'\""+", 2500);");
					else if (classtype.equals("p"))
						out.println("setTimeout("+"\"javascript:location.href='../view/patient.html'\""+", 2500);");
				}
		    	out.println("</script></div>");
				out.println("</div>");
				conn.rollback();
