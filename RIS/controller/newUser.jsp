...
<% 
	if(request.getParameter("newuser") != null && ((Boolean)session.getAttribute("isOracleLogin")) && ((Boolean)session.getAttribute("isUserLogin")))
        {			
	        ...
	        if(skip != null){
		        ...
		        if ((request.getParameter("personid") == "")){
			    	...
			    	out.println("setTimeout("+"\"javascript:location.href='../view/addUser.html'\""+", 2500);");
